...
[![🐍 Python](https://img.shields.io/badge/🐍-Python%20Backend-3776AB?style=flat-square)](https://python.org)
...
├── server.py           # 🐍 Python Flask server — AI generators
...
Open `index.html` directly in any browser for the static template.  
Run the Python server for full AI generator functionality.
